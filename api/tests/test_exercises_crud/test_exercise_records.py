...
class FakeExerciseRecordRepo:
    ...
    def create_exercise_record(self, exercise_record: ExerciseRecordIn):
        return ExerciseRecordOut(
            id=999,
            exercise_template_id=exercise_record.exercise_template_id,
...
def test_create_exercise_record():
    ...
    assert data["exercise_template_id"] == new_exercise_record["exercise_template_id"]
...
def test_update_one_exercise_record():
    ...
    assert data["exercise_template_id"] == new_record["exercise_template_id"]
